  ...
  return (
    <div className="space-y-3 p-4">
      <div className="flex items-center gap-2 rounded-md border border-border bg-muted/40 px-2.5 py-1.5">
        ...
        <span className="font-mono text-[10px] text-muted-foreground">search booksâ€¦</span>
      </div>
        ...
        >
          <motion.div variants={stagger} initial="hidden" animate="show">
            ...
            <motion.p variants={fadeUp} className="mt-5 max-w-xl text-lg text-muted-foreground">
              Hi, I'm <span className="text-foreground font-medium">MohammadHosein Ebrahimi</span> â€” a fullstack developer with
          ...
          >
            <motion.div variants={fadeUp}>
              ...
              <p className="mt-3 max-w-xl text-sm text-muted-foreground">
                Three runnable full-stack demos. Each project ships with auth, validation, policies and a clean UI â€” built to mirror real production work.
              </p>
            </motion.div>
